...
test("5日超ルールで外した物件は excluded.json に『掲載終了』の理由で記録されている", () => {
  ...
  // 適用済み: 上十条3(2026-09-13・10日目) / 滝野川6(2026-09-14・6日目) / 上十条5新築(2026-09-19・6日目。athome も9/14から404)
  for (const [nc, label] of [["nc_20530443", "上十条3"], ["nc_21587170", "滝野川6"], ["nc_21639876", "上十条5新築"], ["nc_21577486", "滝野川1更地"]]) {
    const e = ex[nc];
