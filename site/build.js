...
const focusPreface = `
  <section class="panel">
    <h2>本命2物件の前提のずれ(グラフを読む前に)</h2>
    <div class="logic-body">
      <p class="note" style="margin-top:0">当初の本命3物件のうち<b>岸町2 新築(アドキャスト図面・7,180万)は2026-09-13に他の買主に売れた</b>ため外した
      (SUUMO・athomeとも9月上旬に掲載が消えていた)。以下は残る2物件+賃貸の比較。</p>
      <div style="overflow-x:auto"><table class="kv" style="min-width:560px;font-size:.78rem">
        <tr><th></th><th>岸町2-4-9 土地(MIRASUMO)</th><th>西が丘2 ESPACER C号棟</th></tr>
        <tr><td>総額</td><td>7,480万(土地5,810+建物1,670)</td><td>7,780万(2026-09-08に7,680から+100。ハウスプラザ掲載の値。他2社は7,680のまま)</td></tr>
        <tr><td>居住面積(車庫等除く)</td><td><b>97.7m²</b>(参考プラン・車庫なし)</td><td><b>約90.6m²</b>(延床104.69のうち車庫11.66+備蓄倉庫2.43)</td></tr>
        <tr><td>最寄り</td><td>東十条 歩7分(幾何検算では8〜9分相当)</td><td><b>都営三田線 板橋本町 歩15分</b>(JRは十条21分・赤羽23分。内見時の体感は赤羽まで徒歩22分・自転車なら容易)</td></tr>
        <tr><td>標高・浸水想定</td><td>6.5m・地番の点は0.5m未満(周辺の半分は0.5〜3.0m)</td><td>19.6m・該当なし(台地)</td></tr>
        <tr><td>土砂災害</td><td><b>地番からレッド52m・イエロー32m</b>(仲介経由の役所見解は「区域まで一定の距離・現況ではリスクは低い」)</td><td>代表点で該当なし(番地 西が丘2-19-10 の照合でも土砂0)</td></tr>
        <tr><td>私道</td><td>私道(42条2項)だが<b>通行掘削承諾取得済と図面に明記</b></td><td><b>公道接道・私道負担なし</b>(北5.8m。2物件で唯一、私道の論点がない)</td></tr>
        <tr><td>入居できる時期</td><td><b>建売なら2027年3月完成予定</b>(確認済証取得済)。土地のみなら着工から最短半年〜最長1年</td><td>2026年12月完成予定・引渡12月下旬予定(<b>建築中。完成済ではない</b>)</td></tr>
        <tr><td>内見</td><td>希望(更地)</td><td><b>済み</b>(2026-08-30)</td></tr>
      </table></div>
      ...
      ②岸町2-4-9の適正値は<b>岸町の成約を1件も含まない</b>(事例は上十条・中十条=十条の台地)。
      ...
      詳細は各物件ページ(<a href="property/kishimachi2-mirasumo-204.html">岸町2-4-9 土地</a> /
