  ...
  <section class="panel">
    ...
    <div class="logic-body">
      <div style="overflow-x:auto"><table class="kv" style="min-width:640px;font-size:.78rem">
        ...
        <tr><td>最寄り</td><td>東十条 歩9分</td><td>東十条 歩7分(幾何検算では8〜9分相当)</td><td><b>都営三田線 板橋本町 歩15分</b>(JRは十条21分・赤羽23分。内見時の体感は赤羽まで徒歩22分・自転車なら容易)</td></tr>
        ...
        <tr><td>私道</td><td>二方私道・公道非接道・<b>持分の記載なし</b></td><td>私道(42条2項)だが<b>通行掘削承諾取得済と図面に明記</b></td><td><b>公道接道・私道負担なし</b>(北5.8m。3物件で唯一、私道の論点がない)</td></tr>
        <tr><td>入居できる時期</td><td>2026年12月完成予定(建築中)</td><td><b>着工から最短半年〜最長1年</b>(未着工)</td><td>2026年12月完成予定・引渡12月下旬予定(<b>建築中。完成済ではない</b>)</td></tr>
        <tr><td>内見</td><td>希望(建築中につき現地+同仕様見学)</td><td>希望(更地)</td><td><b>済み</b>(2026-08-30)</td></tr>
      </table></div>
