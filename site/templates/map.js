...
export function renderHazardMap({ grid, ledger, excluded, asOf }) {
  ...
  <div class="panel">
    ...
    <div class="logic-body">
      ...
      <div class="note"><b>読み方</b>: 濃いピンクほど深い。東へ行くほど荒川に近づき深くなる。<span style="color:var(--stamp);font-weight:700">✕印</span>はハザード該当で台帳から外した地区で、いずれも色の濃い側に立っている。<b>候補地区がこの色の上に乗っていたら、掲載元に記載が無くても浸水想定域内</b>だと考えること。斜線は土砂災害警戒区域(イエロー)で、崖線に沿って帯状に走る。</div>
    </div>
  </div>
  ...
  <div class="panel">
    ...
    <div class="logic-body">
      <table class="kv">
        ...
        <tr><td><b>分からない①</b></td><td><b>帯状のハザード</b>。崖線沿いの土砂災害警戒区域は幅が狭く、丁目の代表点では取りこぼす。実際、土砂災害特別警戒区域(レッドゾーン)で除外した西が丘2の現場は、代表点±400mの81点でレッド0点。あれを捕まえたのはathomeの備考欄だけ。<b>掲載元の法令等制限欄の確認は今も必須</b></td></tr>
